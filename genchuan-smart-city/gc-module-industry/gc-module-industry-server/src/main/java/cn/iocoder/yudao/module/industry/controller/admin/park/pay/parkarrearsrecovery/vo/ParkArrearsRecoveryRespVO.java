...
@Schema(description = "管理后台 - 欠费追缴 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ParkArrearsRecoveryRespVO {

    @Schema(description = "主键ID，唯一标识", example = "9446")
