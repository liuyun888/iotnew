  ...
  >
    ...
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">预警告警等级维度统计详情</span>
    ...
    <div class="detail-content">
      <div class="grid-layout">
        ...
        <el-card class="info-card basic-card">
          ...
          <div class="card-body">
            ...
            <div class="info-item">
              ...
              <span class="value key-field">{{ detailData?.levelStatId || '-' }}</span>
            </div>
            <div class="info-item">
        ...
        <!-- 预警等级信息卡片：马克龙浅红 -->
        <el-card class="info-card level-card">
          <template #header>
            <div class="card-header level-header">
              <span class="header-title">预警等级信息</span>
            </div>
          </template>
          <div class="card-body">
            <div class="info-item">
              <span class="label">预警等级：</span>
              <span class="value" :class="getWarnLevelClass(detailData?.warnLevelCode)">
                {{ detailData?.warnLevel || '-' }}
              </span>
            </div>
            <div class="info-item">
              <span class="label">预警等级编码：</span>
              <span class="value key-field">{{ detailData?.warnLevelCode || '-' }}</span>
            </div>
            <div class="info-item">
...
import { EarlyWarnLevelVO } from '@/api/dataHub/warningAlarm/warnAlarmStatAnalysis/earlywarnlevel'

defineOptions({ name: 'EarlyWarnLevelDetail' })
...
const props = defineProps({
  ...
  detailData: {
    type: Object as () => EarlyWarnLevelVO | null,
    default: null
  }
})
