  ...
  >
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">类型统计详情</span>
    ...
    <div class="detail-container">
      <div class="grid-layout">
        ...
        <el-card class="info-card base-info-card">
          ...
          <div class="card-body">
            ...
            <div class="info-item">
              ...
              <span class="value font-bold text-blue-600">{{ detailData.typeStatId || '-' }}</span>
            </div>
            <div class="info-item">
        ...
        <el-card class="info-card area-info-card">
          ...
          <div class="card-body">
            ...
            <div class="info-item">
              ...
              <span class="value">{{ detailData.inspectType || '-' }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="info-card inspect-info-card">
          ...
          <div class="card-body">
            <div class="info-item">
              ...
              <span class="value">{{ detailData.inspectCount || 0 }}</span>
            </div>
            <div class="info-item">
              <span class="label">参与人员数：</span>
              <span class="value">{{ detailData.participantCount || 0 }}</span>
            </div>
            <div class="info-item">
              <span class="label">平均巡查时长：</span>
              <span class="value">{{ detailData.avgInspectEndure || 0 }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="info-card problem-info-card">
          ...
          <div class="card-body">
            <div class="info-item">
              <span class="label">发现问题数：</span>
              <span class="value">{{ detailData.foundProblemCount || 0 }}</span>
            </div>
            <div class="info-item">
              <span class="label">问题发现率：</span>
              <el-tag :type="getFoundRateTag(detailData.problemFoundRate)">
                {{ detailData.problemFoundRate ? detailData.problemFoundRate + '%' : '0%' }}
              </el-tag>
            </div>
            <div class="info-item">
...
import { InspectTypeRptVO } from '@/api/dataHub/supervisionInspection/patrolStatisticalReport/typeStatisticalReport'
...
const props = defineProps({
  ...
  data: {
    type: Object as () => InspectTypeRptVO,
    default: () => ({})
  }
})
...
const detailData = ref<InspectTypeRptVO>({} as InspectTypeRptVO)
...
// 获取问题发现率样式类
const getFoundRateTag = (rate?: number) => {
  if (!rate) return 'info'
  return rate >= 30 ? 'danger' : 'success'
}
