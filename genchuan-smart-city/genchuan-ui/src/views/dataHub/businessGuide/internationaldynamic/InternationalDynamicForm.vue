  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="动态ID" prop="internationalDynamicId">
        <el-input v-model="formData.internationalDynamicId" placeholder="请输入动态ID" />
      </el-form-item>
      <el-form-item label="动态标题" prop="dynamicTitle">
        <el-input v-model="formData.dynamicTitle" placeholder="请输入动态标题" />
      </el-form-item>
      <el-form-item label="英文标题" prop="dynamicTitleEn">
        <el-input v-model="formData.dynamicTitleEn" placeholder="请输入英文标题" />
      </el-form-item>
      <el-form-item label="来源国家地区" prop="sourceCountry">
        <el-input v-model="formData.sourceCountry" placeholder="请输入来源国家地区" />
      </el-form-item>
      ...
      <el-form-item label="英文详情" prop="dynamicDetailEn">
        <el-input v-model="formData.dynamicDetailEn" placeholder="请输入英文详情" />
      </el-form-item>
...
/** 国际行业动态 表单 */
defineOptions({ name: 'InternationalDynamicForm' })
...
const formRules = reactive({
  internationalDynamicId: [{ required: true, message: '动态ID不能为空', trigger: 'blur' }],
  dynamicTitle: [{ required: true, message: '动态标题不能为空', trigger: 'blur' }],
  sourceCountry: [{ required: true, message: '来源国家地区不能为空', trigger: 'blur' }],
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      formData.value = await InternationalDynamicApi.getInternationalDynamic(id)
    } finally {
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    const data = formData.value as unknown as InternationalDynamicVO
    if (formType.value === 'create') {
      await InternationalDynamicApi.createInternationalDynamic(data)
      message.success(t('common.createSuccess'))
    } else {
      await InternationalDynamicApi.updateInternationalDynamic(data)
