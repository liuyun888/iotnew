  ...
  <div class="analysis-grid-page">
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="网格名称" align="center" prop="gridName" min-width="160" />
        <el-table-column label="网格类型" align="center" prop="gridType" min-width="120" />
        <el-table-column label="所在街道名称" align="center" prop="streetName" min-width="160" />
        <el-table-column label="监测部件在线率" align="center" prop="monCompOnlineRate" min-width="140" />
        <el-table-column label="事件处置及时率" align="center" prop="evtTimelyHandleRate" min-width="140" />
        <el-table-column
          label="创建时间"
          align="center"
          prop="createTimeSys"
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:analysis-grid:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="网格ID">{{ selectedRow?.gridId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="网格名称">{{ selectedRow?.gridName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="网格类型">{{ selectedRow?.gridType || '-' }}</el-descriptions-item>
          <el-descriptions-item label="所在街道代码">{{ selectedRow?.streetCode || '-' }}</el-descriptions-item>
          <el-descriptions-item label="所在街道名称">{{ selectedRow?.streetName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="监测部件在线率">{{ selectedRow?.monCompOnlineRate || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事件处置及时率">{{ selectedRow?.evtTimelyHandleRate || '-' }}</el-descriptions-item>
...
const selectedRow = ref<AnalysisGridVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: AnalysisGridVO) => {
