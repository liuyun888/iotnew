<template>
  <div class="analysis-mon-evt-page">
    <!-- 搜索区域 -->
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:analysis-mon-evt:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
...
const selectedRow = ref<AnalysisMonEvtVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: AnalysisMonEvtVO) => {
