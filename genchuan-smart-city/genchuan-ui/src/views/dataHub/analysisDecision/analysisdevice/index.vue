<template>
  <div class="analysis-device-page">
    <!-- 搜索区域 -->
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="设备大类名称" align="center" prop="deviceMajorName" min-width="160" />
        <el-table-column label="设备小类名称" align="center" prop="deviceMinorName" min-width="160" />
        <el-table-column label="设备总数量" align="center" prop="totalDeviceCount" min-width="120" />
        <el-table-column label="设备在线率" align="center" prop="deviceOnlineRate" min-width="120" />
        <el-table-column label="设备故障率" align="center" prop="deviceFaultRate" min-width="120" />
        <el-table-column
          label="系统创建时间"
          align="center"
          prop="createTimeSys"
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:analysis-device:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="设备大类ID">{{ selectedRow?.deviceMajorId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="设备大类名称">{{ selectedRow?.deviceMajorName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="设备小类ID">{{ selectedRow?.deviceMinorId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="设备小类名称">{{ selectedRow?.deviceMinorName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="设备总数量">{{ selectedRow?.totalDeviceCount || '-' }}</el-descriptions-item>
          <el-descriptions-item label="设备在线率">{{ selectedRow?.deviceOnlineRate || '-' }}</el-descriptions-item>
          <el-descriptions-item label="数据上传频率">{{ selectedRow?.dataUploadFreq || '-' }}</el-descriptions-item>
          <el-descriptions-item label="设备故障率">{{ selectedRow?.deviceFaultRate || '-' }}</el-descriptions-item>
...
const selectedRow = ref<AnalysisDeviceVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: AnalysisDeviceVO) => {
