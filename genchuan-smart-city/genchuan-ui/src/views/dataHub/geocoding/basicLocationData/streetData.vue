    ...
    <div class="cc-main-content">
      ...
      <div class="cc-search-css" ref="searchRef">
        <el-form
          ...
          label-width="68px"
        >
          <el-form-item label="名称" prop="streetName">
            <el-input
          ...
          <el-form-item label="标识码" prop="streetCode">
            <el-input
          ...
          <el-form-item>
            ...
            <el-button
              ...
              v-hasPermi="['basicLocationData:streetData:create']"
            >
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column
            ...
            prop="direction"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('走向')"
          />
          <el-table-column
            label="中心线坐标串"
            min-width="150"
            align="center"
            prop="centerLineCoords"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('中心线坐标串')"
          />
          <el-table-column
            label="数据来源"
            min-width="150"
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button
                ...
                v-hasPermi="['basicLocationData:streetData:query']"
                >详细
              </el-button>
              <el-button
                type="primary"
                ...
                v-hasPermi="['basicLocationData:streetData:update']"
                >编辑
              </el-button>
              <el-button
                type="danger"
                ...
                v-hasPermi="['basicLocationData:streetData:delete']"
                >删除
              </el-button>
            </template>
          </el-table-column>
        ...
        >
          ...
          <div class="drawer-content">
            ...
            <template v-if="drawerConfig.active == 1">
              ...
              >
                <ul>
                  <li class="width50"><span>名称：</span>{{ queryData.streetName }}</li>
                  <li class="width50"><span>标识码：</span>{{ queryData.streetCode }}</li>
                  <li class="width50"><span>别名：</span>{{ queryData.alias }}</li>
                  <li class="width50"><span>曾用名：</span>{{ queryData.oldName }}</li>
                  <li class="width50"><span>最小门牌号：</span>{{ queryData.minHouseNum }}</li>
                  <li class="width50"><span>最大门牌号：</span>{{ queryData.maxHouseNum }}</li>
                  <li class="width50"><span>起点名称：</span>{{ queryData.beginningName }}</li>
                  <li class="width50"><span>止点名称：</span>{{ queryData.endingName }}</li>
                  <li class="width50"><span>走向：</span>{{ queryData.direction }}</li>
                  <li class="width50"
                    ><span>中心线坐标串：</span>{{ queryData.centerLineCoords }}</li
                  >
              ...
              <div class="edit-content" v-loading="drawerConfig.loading" v-else>
                ...
                >
                  <el-form-item
                    ...
                    :rules="[]"
                  >
                    <el-input placeholder="请输入名称" v-model="formData.streetName" clearable />
                  </el-form-item>
                  <el-form-item
                    label="标识码："
                    prop="streetCode"
                    ...
                    :rules="[]"
                  >
                    <el-input placeholder="请输入标识码" v-model="formData.streetCode" clearable />
                  </el-form-item>
                  <el-form-item
                    label="别名："
                    prop="alias"
                  ...
                  >
                    <el-input
                      placeholder="请输入最小门牌号"
                      v-model="formData.minHouseNum"
                      clearable
                    />
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    <el-input
                      placeholder="请输入最大门牌号"
                      v-model="formData.maxHouseNum"
                      clearable
                    />
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    <el-input
                      placeholder="请输入起点名称"
                      v-model="formData.beginningName"
                      clearable
                    />
                  </el-form-item>
                  <el-form-item
                  ...
                  <el-form-item
                    ...
                    :rules="[]"
                  >
                    <el-input placeholder="请输入走向" v-model="formData.direction" clearable />
                  </el-form-item>
                  <el-form-item
                    label="中心线坐标串："
                    prop="centerLineCoords"
                  ...
                  >
                    <el-input
                      placeholder="请输入中心线坐标串"
                      v-model="formData.centerLineCoords"
                      clearable
                    />
                  </el-form-item>
                  <el-form-item
...
import * as streetDataApi from '@/api/dataHub/geocoding/basicLocationData/streetData'
...
const tableInitData = async () => {
  ...
  try {
    ...
    const res = await streetDataApi.listPage(merged)
  ...
  if (valid) {
    try {
      ...
      if (drawerConfig.value.type === 'add' && !formData.value.id) {
        await streetDataApi.createData(data)
        ElMessage.success('保存成功')
      } else {
        await streetDataApi.updateData(data)
...
const queryClick = async (row) => {
  ...
  drawerConfig.value.title = '街巷数据-详细信息'
}
// 点击编辑按钮
const editClick = async (row) => {
  ...
  drawerConfig.value.title = '编辑街巷数据'
}
// 点击删除按钮
const delClick = (row) => {
  ElMessageBox.confirm('请注意：确认后，所有相关数据将不可恢复。', `确定要删除吗？`, {
    ...
    .then(async () => {
      try {
        await streetDataApi.delData(row.id)
        await tableInitData()
        ElMessage({
          type: 'success',
          message: '删除成功'
...
const addClick = async () => {
  ...
  drawerConfig.value.title = '新增街巷数据'
  drawerConfig.value.active = '1'
}
//drawer 配置
...
const tableColumns = ref([
  ...
  { label: '最小门牌号', visible: true },
  { label: '最大门牌号', visible: true },
  { label: '起点名称', visible: true },
  { label: '止点名称', visible: true },
  { label: '走向', visible: true },
  { label: '中心线坐标串', visible: true },
