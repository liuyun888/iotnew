  ...
  <div class="evt-rpt-reg-page">
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="接报ID" align="center" prop="rptId" min-width="140" />
        <el-table-column label="事件编码" align="center" prop="evtCode" min-width="160" />
        <el-table-column label="事件类型名称" align="center" prop="evtTypeName" min-width="160" />
        <el-table-column label="事发区域名称" align="center" prop="incidentRegionName" min-width="160" />
        <el-table-column label="事发位置" align="center" prop="incidentLocation" min-width="200" show-overflow-tooltip />
        <el-table-column label="事件描述" align="center" prop="evtDesc" min-width="250" show-overflow-tooltip />
        <!-- 操作列 -->
        <el-table-column
          label="操作"
          align="center"
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:evt-rpt-reg:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      <div class="detail-header flex justify-between items-center p-4 border-b">
        <h3 class="text-lg font-semibold">事件接报登记详情</h3>
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="接报ID">{{ selectedRow?.rptId || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="区域代码">{{ selectedRow?.incidentRegionCode || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事发区域名称">{{ selectedRow?.incidentRegionName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事发位置">{{ selectedRow?.incidentLocation || '-' }}</el-descriptions-item>
          <el-descriptions-item label="坐标X">{{ selectedRow?.incidentCoordX || '-' }}</el-descriptions-item>
          <el-descriptions-item label="坐标Y">{{ selectedRow?.incidentCoordY || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事件描述">{{ selectedRow?.evtDesc || '-' }}</el-descriptions-item>
        </el-descriptions>
      </div>
    </div>
...
const selectedRow = ref<EvtRptRegVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: EvtRptRegVO) => {
