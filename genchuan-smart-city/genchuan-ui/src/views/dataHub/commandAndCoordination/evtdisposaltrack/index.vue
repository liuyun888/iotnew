<template>
  <div class="analysis-evt-disposal-track-page">
    <!-- 搜索区域 -->
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="跟踪ID" align="center" prop="trackId" min-width="140" />
        ...
        <el-table-column label="当前处置节点" align="center" prop="currentNode" min-width="160" />
        <el-table-column label="处置人员" align="center" prop="handlerName" min-width="120" />
        <el-table-column
          label="处置开始时间"
          align="center"
          prop="startTime"
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:evt-disposal-track:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      <div class="detail-header flex justify-between items-center p-4 border-b">
        <h3 class="text-lg font-semibold">事件处置跟踪详情</h3>
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="跟踪ID">{{ selectedRow?.trackId || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="当前处置节点">{{ selectedRow?.currentNode || '-' }}</el-descriptions-item>
          <el-descriptions-item label="处置人员">{{ selectedRow?.handlerName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="处置开始时间">{{ dateFormatter(selectedRow?.startTime) || '-' }}</el-descriptions-item>
          <el-descriptions-item label="预计完成时间">{{ dateFormatter(selectedRow?.estCompleteTime) || '-' }}</el-descriptions-item>
        </el-descriptions>
      </div>
    </div>
...
const selectedRow = ref<EvtDisposalTrackVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: EvtDisposalTrackVO) => {
...
.analysis-evt-disposal-track-page {
  padding: 8px;
  height: 100vh;
