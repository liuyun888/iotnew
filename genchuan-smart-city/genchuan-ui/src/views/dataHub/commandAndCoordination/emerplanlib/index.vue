<template>
  <div class="analysis-emer-plan-lib-page">
    <!-- 搜索区域 -->
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="预案ID" align="center" prop="planId" min-width="140" />
        <el-table-column label="预案编号" align="center" prop="planNo" min-width="160" />
        <el-table-column label="预案标准名称" align="center" prop="planName" min-width="200" />
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:emer-plan-lib:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      <div class="detail-header flex justify-between items-center p-4 border-b">
        <h3 class="text-lg font-semibold">预案库详情</h3>
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="预案ID">{{ selectedRow?.planId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="预案编号">{{ selectedRow?.planNo || '-' }}</el-descriptions-item>
          <el-descriptions-item label="预案标准名称">{{ selectedRow?.planName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="分类ID">{{ selectedRow?.catId || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="预案版本">{{ selectedRow?.planVersion || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="预案文档路径">{{ selectedRow?.planDocPath || '-' }}</el-descriptions-item>
        </el-descriptions>
      </div>
    </div>
...
const selectedRow = ref<EmerPlanLibVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: EmerPlanLibVO) => {
