<template>
  <div class="biz-mng-matter-ext-page">
    <!-- 搜索区域 -->
    <ContentWrap class="search-container">
      <div class="search-content">
        ...
        >
          <div class="form-row">
            <!-- 保留核心必填搜索字段 -->
            <el-form-item label="扩展ID" prop="mngMatterExtId">
              <el-input
            ...
            <el-form-item label="归属大类名称" prop="matterMajorName">
              <el-input
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="扩展ID" align="center" prop="mngMatterExtId" min-width="140" />
        <el-table-column label="归属大类ID" align="center" prop="matterMajorId" min-width="140" />
        <el-table-column label="归属大类名称" align="center" prop="matterMajorName" min-width="160" />
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:biz-mng-matter-ext:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      <div class="detail-header flex justify-between items-center p-4 border-b">
        <h3 class="text-lg font-semibold">管理事项扩展配置详情</h3>
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="扩展ID">{{ selectedRow?.mngMatterExtId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="归属大类ID">{{ selectedRow?.matterMajorId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="归属大类名称">{{ selectedRow?.matterMajorName || '-' }}</el-descriptions-item>
...
const list = ref<BizMngMatterExtVO[]>([]) // 列表数据
const total = ref(0) // 总条数
const exportLoading = ref(false) // 导出加载状态

// 详情抽屉相关
const isDetailShow = ref(false)
const selectedRow = ref<BizMngMatterExtVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: BizMngMatterExtVO) => {
...
const getList = async () => {
  ...
  try {
    ...
    console.error('查询管理事项扩展列表失败:', error)
...
const handleDelete = async (id: number) => {
  try {
    ...
    console.error('删除管理事项扩展失败:', error)
...
const handleExport = async () => {
  try {
    ...
    console.error('导出管理事项扩展失败:', error)
