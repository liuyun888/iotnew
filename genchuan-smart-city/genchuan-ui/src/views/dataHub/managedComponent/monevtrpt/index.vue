  ...
  <div class="mon-evt-rpt-page">
      ...
      <div class="search-content">
        ...
        >
          <div class="form-row">
            ...
            <el-form-item label="统计区域" prop="regionName">
              <el-input
                v-model="queryParams.regionName"
                placeholder="请输入统计区域名称"
                clearable
                @keyup.enter="handleQuery"
                class="!w-160px"
              />
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="统计周期名称" align="center" prop="statCycleName" min-width="140" />
        <el-table-column label="统计区域" align="center" prop="regionName" min-width="140" />
        <el-table-column label="事件大类" align="center" prop="evtMajorName" min-width="140" />
        <el-table-column label="事件小类" align="center" prop="evtMinorName" min-width="140" />
        <el-table-column label="处置部门" align="center" prop="deptName" min-width="140" />
        <el-table-column label="上报总数" align="center" prop="totalRptCount" min-width="100" />
        <el-table-column label="已办结数" align="center" prop="completedCount" min-width="100" />
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:mon-evt-rpt:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="统计区域">{{ selectedRow?.regionName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事件大类ID">{{ selectedRow?.evtMajorId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事件大类名称">{{ selectedRow?.evtMajorName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事件小类ID">{{ selectedRow?.evtMinorId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="事件小类名称">{{ selectedRow?.evtMinorName || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="一级事件数">{{ selectedRow?.level1Count || '-' }}</el-descriptions-item>
        </el-descriptions>
      </div>
    </div>
...
const selectedRow = ref<MonEvtRptVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: MonEvtRptVO) => {
