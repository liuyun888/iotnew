<template>
  <div class="biz-mng-matter-minor-page">
    <!-- 搜索区域 -->
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="管理事项小类ID" align="center" prop="mngMatterMinorId" min-width="140" />
        <el-table-column label="所属大类ID" align="center" prop="parentMajorId" min-width="140" />
        <el-table-column label="所属大类名称" align="center" prop="parentMajorName" min-width="160" />
        <el-table-column label="小类名称" align="center" prop="matterMinorName" min-width="160" />
        <el-table-column label="小类代码" align="center" prop="matterMinorCode" min-width="140" />
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:biz-mng-matter-minor:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="管理事项小类ID">{{ selectedRow?.mngMatterMinorId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="所属大类ID">{{ selectedRow?.parentMajorId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="所属大类名称">{{ selectedRow?.parentMajorName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="小类代码">{{ selectedRow?.matterMinorCode || '-' }}</el-descriptions-item>
          <el-descriptions-item label="小类名称">{{ selectedRow?.matterMinorName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="小类说明">{{ selectedRow?.matterMinorDesc || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="是否扩展类">{{ selectedRow?.isExt || '-' }}</el-descriptions-item>
...
const selectedRow = ref<BizMngMatterMinorVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: BizMngMatterMinorVO) => {
