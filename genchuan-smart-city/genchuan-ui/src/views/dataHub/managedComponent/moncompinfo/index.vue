  ...
  <div class="mon-comp-info-page">
    ...
    <ContentWrap class="list-container">
      ...
      >
        ...
        <el-table-column label="部件ID" align="center" prop="monCompId" min-width="140" />
        <el-table-column label="部件标识码" align="center" prop="compCode" min-width="160" />
        <el-table-column label="部件名称" align="center" prop="compName" min-width="160" />
        <el-table-column label="部件分类ID" align="center" prop="compCatId" min-width="140" />
        <el-table-column label="主管部门名称" align="center" prop="deptName" min-width="160" />
        <el-table-column label="所在区域" align="center" prop="regionName" min-width="160" />
        <el-table-column
          label="系统创建时间"
          align="center"
          prop="createTimeSys"
          ...
          <template #default="scope">
            <div class="operation-btn-group">
              <el-button
                ...
                v-hasPermi="['datacenter:mon-comp-info:detail']"
                class="operation-btn"
              >
                详情
              </el-button>
    ...
    >
      ...
      <div class="detail-content p-6">
        ...
        >
          ...
          <el-descriptions-item label="部件ID">{{ selectedRow?.monCompId || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="所在行政区域代码">{{ selectedRow?.regionCode || '-' }}</el-descriptions-item>
          <el-descriptions-item label="所在行政区域名称">{{ selectedRow?.regionName || '-' }}</el-descriptions-item>
          <el-descriptions-item label="所在网格ID">{{ selectedRow?.gridId || '-' }}</el-descriptions-item>
          <el-descriptions-item label="所在网格名称">{{ selectedRow?.gridName || '-' }}</el-descriptions-item>
...
const selectedRow = ref<MonCompInfoVO | null>(null)
...
/** 打开详情伪抽屉 */
const openDetail = (row: MonCompInfoVO) => {
