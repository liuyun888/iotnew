  ...
  >
    ...
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">指标体系详情</span>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            ...
            <div class="info-item">
              <span class="label">指标体系ID：</span>
              <span class="value font-bold text-blue-600">{{ formData.idxSystemId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">指标体系名称：</span>
              <span class="value font-bold text-blue-600">{{ formData.idxSystemName || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">体系编码：</span>
              <span class="value font-bold text-blue-600">{{ formData.systemCode || '-' }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          <template #header>
            <div class="card-header bg-pink-50 text-pink-700">体系配置信息</div>
          </template>
          <div class="card-content">
            <div class="info-item">
            ...
            <div class="info-item">
              <span class="label">体系版本：</span>
              <span class="value font-bold text-pink-600">{{ formData.systemVersion || '-' }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              <span class="label">体系描述：</span>
              <span class="value">{{ formData.systemDesc || '-' }}</span>
            </div>
          </div>
        </el-card>
...
import { EvalIdxSystemVO } from '@/api/dataHub/comprehensiveEval/evalIndicatorMgmt/evalIndSysMgmt'

/** 指标体系详情抽屉 */
defineOptions({ name: 'EvalIdxSystemDetailDrawer' })
...
const formData = ref<EvalIdxSystemVO>({
  id: 0,
  idxSystemId: '',
  idxSystemName: '',
  systemCode: '',
...
/** 打开抽屉 */
const open = (row: EvalIdxSystemVO) => {
  formData.value = { ...row }
