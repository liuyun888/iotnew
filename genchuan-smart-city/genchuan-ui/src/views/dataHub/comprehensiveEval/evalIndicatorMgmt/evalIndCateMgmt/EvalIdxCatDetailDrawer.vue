  ...
  >
    ...
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">指标分类详情</span>
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            ...
            <div class="info-item">
              <span class="label">指标分类ID：</span>
              <span class="value font-bold text-blue-600">{{ formData.idxCatId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">指标分类名称：</span>
              <span class="value font-bold text-blue-600">{{ formData.idxCatName || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">分类编码：</span>
              <span class="value font-bold text-blue-600">{{ formData.catCode || '-' }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          <template #header>
            <div class="card-header bg-pink-50 text-pink-700">关联体系信息</div>
          </template>
          <div class="card-content">
            <div class="info-item">
            ...
            <div class="info-item">
              ...
              <span class="value">{{ formData.catDesc || '-' }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          <template #header>
            <div class="card-header bg-green-50 text-green-700">状态信息</div>
          </template>
          <div class="card-content">
            <div class="info-item">
...
import { EvalIdxCatVO } from '@/api/dataHub/comprehensiveEval/evalIndicatorMgmt/evalIndCateMgmt'

/** 指标分类详情抽屉 */
defineOptions({ name: 'EvalIdxCatDetailDrawer' })
...
const formData = ref<EvalIdxCatVO>({
  id: 0,
  idxCatId: '',
  idxCatName: '',
  catCode: '',
