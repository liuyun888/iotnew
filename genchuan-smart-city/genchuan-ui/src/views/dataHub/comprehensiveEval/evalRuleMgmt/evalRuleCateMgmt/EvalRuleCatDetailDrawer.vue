  ...
  >
    ...
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">规则分类详情</span>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            ...
            <div class="info-item">
              <span class="label">规则分类ID：</span>
              <span class="value font-bold text-blue-600">{{ formData.ruleCatId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">规则分类名称：</span>
              <span class="value font-bold text-blue-600">{{ formData.ruleCatName || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">分类编码：</span>
              <span class="value font-bold text-blue-600">{{ formData.ruleCatCode || '-' }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            <div class="info-item">
              <span class="label">适用指标体系ID：</span>
              <span class="value">{{ formData.idxSystemId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">适用指标体系名称：</span>
...
import { EvalRuleCatVO } from '@/api/dataHub/comprehensiveEval/evalRuleMgmt/evalRuleCateMgmt'

/** 规则分类详情抽屉 */
defineOptions({ name: 'EvalRuleCatDetailDrawer' })
...
const formData = ref<EvalRuleCatVO>({
  id: 0,
  ruleCatId: '',
  ruleCatName: '',
  ruleCatCode: '',
