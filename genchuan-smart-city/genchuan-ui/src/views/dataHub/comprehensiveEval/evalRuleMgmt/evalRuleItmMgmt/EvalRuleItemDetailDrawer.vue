  ...
  >
    ...
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">规则项详情</span>
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            ...
            <div class="info-item">
              <span class="label">规则项ID：</span>
              <span class="value font-bold text-blue-600">{{ formData.ruleItemId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">规则项名称：</span>
              <span class="value font-bold text-blue-600">{{ formData.ruleItemName || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">规则项编码：</span>
              <span class="value font-bold text-blue-600">{{ formData.ruleItemCode || '-' }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            <div class="info-item">
              <span class="label">所属规则分类ID：</span>
              <span class="value">{{ formData.ruleCatId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">所属规则分类名称：</span>
              <span class="value font-bold text-pink-600">{{ formData.ruleCatName || '-' }}</span>
            </div>
            <div class="info-item">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          <template #header>
            <div class="card-header bg-green-50 text-green-700">规则配置信息</div>
          </template>
          <div class="card-content">
            <div class="info-item">
              <span class="label">规则类型：</span>
              <span class="value font-bold text-green-600">{{ formData.ruleType || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">满分值：</span>
              <span class="value font-bold text-green-600">{{ formData.fullScore || 0 }}</span>
            </div>
            <div class="info-item">
              <span class="label">评分逻辑：</span>
              <span class="value">{{ formData.scoreLogic || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">规则描述：</span>
              <span class="value">{{ formData.ruleDesc || '-' }}</span>
            </div>
            <div class="info-item">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            <div class="info-item">
              ...
              <span class="value font-bold text-yellow-600">{{ formData.createUser || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">更新人：</span>
              <span class="value font-bold text-yellow-600">{{ formData.updateUser || '-' }}</span>
            </div>
            <div class="info-item">
...
import { EvalRuleItemVO } from '@/api/dataHub/comprehensiveEval/evalRuleMgmt/evalRuleItmMgmt'

/** 规则项详情抽屉 */
defineOptions({ name: 'EvalRuleItemDetailDrawer' })
...
const formData = ref<EvalRuleItemVO>({
  id: 0,
  ruleItemId: '',
  ruleItemName: '',
  ruleItemCode: '',
