  ...
  >
    ...
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">标准分类详情</span>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            ...
            <div class="info-item">
              <span class="label">标准分类ID：</span>
              <span class="value font-bold text-blue-600">{{ formData.stdCatId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">标准分类名称：</span>
              <span class="value font-bold text-blue-600">{{ formData.stdCatName || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">分类编码：</span>
              <span class="value font-bold text-blue-600">{{ formData.stdCatCode || '-' }}</span>
            </div>
          </div>
        </el-card>
...
import { EvalStdCatVO } from '@/api/dataHub/comprehensiveEval/evalStandardMgmt/evalStdCateMgmt'

/** 标准分类详情抽屉 */
defineOptions({ name: 'EvalStdCatDetailDrawer' })
...
const formData = ref<EvalStdCatVO>({
  id: 0,
  stdCatId: '',
  stdCatName: '',
  stdCatCode: '',
