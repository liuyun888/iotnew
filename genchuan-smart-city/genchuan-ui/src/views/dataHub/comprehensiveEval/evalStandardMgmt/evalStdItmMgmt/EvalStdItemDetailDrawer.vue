  ...
  >
    ...
    <template #header>
      <div class="flex justify-between items-center w-full px-2">
        <span class="text-lg font-bold text-gray-800">标准项详情</span>
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            ...
            <div class="info-item">
              <span class="label">标准项ID：</span>
              <span class="value font-bold text-blue-600">{{ formData.stdItemId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">标准项名称：</span>
              <span class="value font-bold text-blue-600">{{ formData.stdItemName || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">标准项编码：</span>
              <span class="value font-bold text-blue-600">{{ formData.stdItemCode || '-' }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          ...
          <div class="card-content">
            <div class="info-item">
              <span class="label">所属标准分类ID：</span>
              <span class="value">{{ formData.stdCatId || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">所属标准分类名称：</span>
              <span class="value font-bold text-pink-600">{{ formData.stdCatName || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">标准等级：</span>
              <span class="value font-bold text-pink-600">{{ formData.stdLevel || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="label">排序序号：</span>
              <span class="value font-bold text-pink-600">{{ formData.sortNum || 0 }}</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          <template #header>
            <div class="card-header bg-green-50 text-green-700">评分配置信息</div>
          </template>
          <div class="card-content">
            <div class="info-item">
              <span class="label">分数下限：</span>
              <span class="value font-bold text-green-600">{{ formData.scoreMin || 0 }}</span>
            </div>
            <div class="info-item">
              <span class="label">分数上限：</span>
              <span class="value font-bold text-green-600">{{ formData.scoreMax || 0 }}</span>
            </div>
            <div class="info-item">
              <span class="label">标准描述：</span>
              <span class="value">{{ formData.stdDesc || '-' }}</span>
            </div>
            <div class="info-item">
        ...
        <el-card class="card-beautify" :shadow="hoverShadow">
          <template #header>
            <div class="card-header bg-yellow-50 text-yellow-700">操作信息</div>
          </template>
          <div class="card-content">
            <div class="info-item">
...
import { EvalStdItemVO } from '@/api/dataHub/comprehensiveEval/evalStandardMgmt/evalStdItmMgmt'

/** 标准项详情抽屉 */
defineOptions({ name: 'EvalStdItemDetailDrawer' })
...
const formData = ref<EvalStdItemVO>({
  id: 0,
  stdItemId: '',
  stdItemName: '',
  stdItemCode: '',
