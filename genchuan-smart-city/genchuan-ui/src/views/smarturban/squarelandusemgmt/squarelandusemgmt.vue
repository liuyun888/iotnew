      ...
      <div class="cc-title-css">
        ...
        <div class="right">
          <el-button
            ...
            v-hasPermi="['smarturban:squarelandusemgmt:create']"
          >
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('规格')"
          >
            <template #default="scope">
              {{ tableFieldShow('规格', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="面积"
          ...
          >
            <template #default="scope">
              {{ tableFieldShow('面积', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="绿地面积"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('绿地面积')"
          >
            <template #default="scope">
              {{ tableFieldShow('绿地面积', scope.row.field) }}
            </template>
          </el-table-column>
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button
                ...
                v-hasPermi="['smarturban:squarelandusemgmt:query']"
                >详细</el-button
              >
              <el-button
                type="primary"
                ...
                v-hasPermi="['smarturban:squarelandusemgmt:update']"
                >编辑</el-button
              >
              <el-button
                type="danger"
                ...
                v-hasPermi="['smarturban:squarelandusemgmt:delete']"
                >删除</el-button
              >
            </template>
          </el-table-column>
        ...
        <div class="drawer-content">
          ...
          >
            <ul>
              ...
              >
              <li class="width50"
                ><span>规格：</span>{{ tableFieldShow('规格', queryData.field) }}</li
              >
              <li class="width50"
                ><span>面积：</span>{{ tableFieldShow('面积', queryData.field) }}</li
              >
              <li class="width50"
                ><span>绿地面积：</span>{{ tableFieldShow('绿地面积', queryData.field) }}</li
              >
            </ul>
          </div>
          ...
          <div class="edit-content" v-loading="drawerConfig.loading" v-else>
            ...
            >
              ...
              <el-form-item
                ...
                :rules="[]"
              >
                <el-input placeholder="请输入规格" v-model="formData.field.规格" clearable />
              </el-form-item>
              <el-form-item
                label="面积："
                prop="field.面积"
              ...
              <el-form-item
                ...
                prop="field.绿地面积"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入绿地面积', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入绿地面积"
                  v-model="formData.field.绿地面积"
                  clearable
                />
              </el-form-item>
            </el-form>
...
const tableInitData = async () => {
  ...
  try {
    let params = {
      ...
      sortOrder: 'DESC',
      assetProfileId: '87889dc0-7728-11f0-bd39-2dc5ccdb39ef' //资产配置id
    }
...
const queryClick = async (row) => {
  ...
  drawerConfig.value.title = '广场用地管理-详细信息'
}
// 点击编辑按钮
const editClick = async (row) => {
  ...
  formData.value.field.规格 = tableFieldShow('规格', row.field) //规格
  formData.value.field.面积 = tableFieldShow('面积', row.field) //面积
  formData.value.field.绿地面积 = tableFieldShow('绿地面积', row.field) //绿地面积

  drawerConfig.value.isDrawer = true
  drawerConfig.value.loading = false
  drawerConfig.value.type = 'edit'
  drawerConfig.value.title = '编辑广场用地管理'
}
// 点击删除按钮
const delClick = (row) => {
...
const addClick = async () => {
  ...
  drawerConfig.value.title = '新增广场用地管理'
}
