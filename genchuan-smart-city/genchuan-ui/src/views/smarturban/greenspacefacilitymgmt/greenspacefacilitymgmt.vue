      ...
      <div class="cc-title-css">
        ...
        <div class="right">
          <el-button
            ...
            v-hasPermi="['smarturban:greenspacefacilitymgmt:create']"
          >
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button
                ...
                v-hasPermi="['smarturban:greenspacefacilitymgmt:query']"
                >详细</el-button
              >
              <el-button
                type="primary"
                ...
                v-hasPermi="['smarturban:greenspacefacilitymgmt:update']"
                >编辑</el-button
              >
              <el-button
                type="danger"
                ...
                v-hasPermi="['smarturban:greenspacefacilitymgmt:delete']"
                >删除</el-button
              >
            </template>
          </el-table-column>
...
const tableInitData = async () => {
  ...
  try {
    let params = {
      ...
      sortOrder: 'DESC',
      assetProfileId: '9d3d56e0-772a-11f0-bd39-2dc5ccdb39ef' //资产配置id
    }
...
const initFormData = {
  ...
  type: '绿地附属设施管理', //资产配置，都是写死固定的资产配置
  field: {
    名称: '', //名称
    地址: '', //地址
    管理单位: '', //管理单位
...
const queryClick = async (row) => {
  ...
  drawerConfig.value.title = '绿地附属设施管理-详细信息'
}
// 点击编辑按钮
const editClick = async (row) => {
  ...
  drawerConfig.value.title = '编辑绿地附属设施管理'
}
// 点击删除按钮
const delClick = (row) => {
...
const addClick = async () => {
  ...
  drawerConfig.value.title = '新增绿地附属设施管理'
}
