      ...
      <div class="cc-title-css">
        ...
        <div class="right">
          <el-button
            ...
            v-hasPermi="['smarturban:treeinfomgmt:create']"
          >
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('栽种数量')"
          >
            <template #default="scope">
              {{ tableFieldShow('栽种数量', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="冠幅"
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('周围环境')"
          >
            <template #default="scope">
              {{ tableFieldShow('周围环境', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="管理单位"
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button
                ...
                v-hasPermi="['smarturban:treeinfomgmt:query']"
                >详细</el-button
              >
              <el-button
                type="primary"
                ...
                v-hasPermi="['smarturban:treeinfomgmt:update']"
                >编辑</el-button
              >
              <el-button
                type="danger"
                ...
                v-hasPermi="['smarturban:treeinfomgmt:delete']"
                >删除</el-button
              >
            </template>
          </el-table-column>
        ...
        <div class="drawer-content">
          ...
          >
            <ul>
              ...
              >
              <li class="width50"
                ><span>栽种数量：</span>{{ tableFieldShow('栽种数量', queryData.field) }}</li
              >
              <li class="width50"
              ...
              >
              <li class="width50"
                ><span>周围环境：</span>{{ tableFieldShow('周围环境', queryData.field) }}</li
              >
              <li class="width50"
...
const tableInitData = async () => {
  ...
  try {
    let params = {
      ...
      sortOrder: 'DESC',
      assetProfileId: 'f1c11a10-7718-11f0-bd39-2dc5ccdb39ef' //资产配置id
    }
...
const queryClick = async (row) => {
  ...
  drawerConfig.value.title = '树木信息管理-详细信息'
}
// 点击编辑按钮
const editClick = async (row) => {
  ...
  formData.value.field.栽种数量 = tableFieldShow('栽种数量', row.field) //栽种数量
  ...
  formData.value.field.周围环境 = tableFieldShow('周围环境', row.field) //周围环境
  formData.value.field.管理单位 = tableFieldShow('管理单位', row.field) //管理单位

  drawerConfig.value.isDrawer = true
  drawerConfig.value.loading = false
  drawerConfig.value.type = 'edit'
  drawerConfig.value.title = '编辑树木信息管理'
}
// 点击删除按钮
const delClick = (row) => {
...
const addClick = async () => {
  ...
  drawerConfig.value.title = '新增树木信息管理'
}
