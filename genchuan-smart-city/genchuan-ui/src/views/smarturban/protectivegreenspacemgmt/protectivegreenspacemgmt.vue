      ...
      <div class="cc-title-css">
        ...
        <div class="right">
          <el-button
            ...
            v-hasPermi="['smarturban:protectivegreenspacemgmt:create']"
          >
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('防护等级')"
          >
            <template #default="scope">
              {{ tableFieldShow('防护等级', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="防护类型"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('防护类型')"
          >
            <template #default="scope">
              {{ tableFieldShow('防护类型', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="管理单位"
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button
                ...
                v-hasPermi="['smarturban:protectivegreenspacemgmt:query']"
                >详细</el-button
              >
              <el-button
                type="primary"
                ...
                v-hasPermi="['smarturban:protectivegreenspacemgmt:update']"
                >编辑</el-button
              >
              <el-button
                type="danger"
                ...
                v-hasPermi="['smarturban:protectivegreenspacemgmt:delete']"
                >删除</el-button
              >
            </template>
          </el-table-column>
        ...
        <div class="drawer-content">
          ...
          >
            <ul>
              ...
              >
              <li class="width50"
                ><span>防护等级：</span>{{ tableFieldShow('防护等级', queryData.field) }}</li
              >
              <li class="width50"
                ><span>防护类型：</span>{{ tableFieldShow('防护类型', queryData.field) }}</li
              >
              <li class="width50"
          ...
          <div class="edit-content" v-loading="drawerConfig.loading" v-else>
            ...
            >
              ...
              <el-form-item
                ...
                prop="field.防护类型"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入防护类型', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入防护类型"
                  v-model="formData.field.防护类型"
                  clearable
                />
              </el-form-item>
              <el-form-item
...
const tableInitData = async () => {
  ...
  try {
    let params = {
      ...
      sortOrder: 'DESC',
      assetProfileId: 'dc17c2e0-7727-11f0-bd39-2dc5ccdb39ef' //资产配置id
    }
...
const queryClick = async (row) => {
  ...
  drawerConfig.value.title = '防护绿地管理-详细信息'
}
// 点击编辑按钮
const editClick = async (row) => {
  ...
  formData.value.field.防护等级 = tableFieldShow('防护等级', row.field) //防护等级
  formData.value.field.防护类型 = tableFieldShow('防护类型', row.field) //防护类型
  ...
  drawerConfig.value.title = '编辑防护绿地管理'
}
// 点击删除按钮
const delClick = (row) => {
...
const addClick = async () => {
  ...
  drawerConfig.value.title = '新增防护绿地管理'
}
...
const tableColumns = ref([
  ...
  { label: '防护等级', visible: true },
  { label: '防护类型', visible: true },
