      ...
      <div class="cc-title-css">
        ...
        <div class="right">
          <el-button
            ...
            v-hasPermi="['smarturban:lawenforcestaffinfomgmt:create']"
          >
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('身份证号')"
          >
            <template #default="scope">
              {{ tableFieldShow('身份证号', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="姓名"
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('政治面貌')"
          >
            <template #default="scope">
              {{ tableFieldShow('政治面貌', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="民族"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('民族')"
          >
            <template #default="scope">
              {{ tableFieldShow('民族', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="学历"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('学历')"
          >
            <template #default="scope">
              {{ tableFieldShow('学历', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="家庭住址"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('家庭住址')"
          >
            <template #default="scope">
              {{ tableFieldShow('家庭住址', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="手机号码"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('手机号码')"
          >
            <template #default="scope">
              {{ tableFieldShow('手机号码', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="入职时间"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('入职时间')"
          >
            <template #default="scope">
              {{ tableFieldShow('入职时间', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="执法证号"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('执法证号')"
          >
            <template #default="scope">
              {{ tableFieldShow('执法证号', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="执法证有效期"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('执法证有效期')"
          >
            <template #default="scope">
              {{ tableFieldShow('执法证有效期', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="职务"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('职务')"
          >
            <template #default="scope">
              {{ tableFieldShow('职务', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="执法机构标识码"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('执法机构标识码')"
          >
            <template #default="scope">
              {{ tableFieldShow('执法机构标识码', scope.row.field) }}
            </template>
          </el-table-column>
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button
                ...
                v-hasPermi="['smarturban:lawenforcestaffinfomgmt:query']"
                >详细</el-button
              >
              <el-button
                type="primary"
                ...
                v-hasPermi="['smarturban:lawenforcestaffinfomgmt:update']"
                >编辑</el-button
              >
              <el-button
                type="danger"
                ...
                v-hasPermi="['smarturban:lawenforcestaffinfomgmt:delete']"
                >删除</el-button
              >
            </template>
          </el-table-column>
        ...
        <div class="drawer-content">
          ...
          >
            <ul>
              ...
              <li class="width50"
                ><span>身份证号：</span>{{ tableFieldShow('身份证号', queryData.field) }}</li
              >
              <li class="width50"
                ><span>姓名：</span>{{ tableFieldShow('姓名', queryData.field) }}</li
              >
              <li class="width50"
                ><span>性别：</span>{{ tableFieldShow('性别', queryData.field) }}</li
              >
              <li class="width50"
                ><span>政治面貌：</span>{{ tableFieldShow('政治面貌', queryData.field) }}</li
              >
              <li class="width50"
                ><span>民族：</span>{{ tableFieldShow('民族', queryData.field) }}</li
              >
              <li class="width50"
                ><span>学历：</span>{{ tableFieldShow('学历', queryData.field) }}</li
              >
              <li class="width50"
                ><span>家庭住址：</span>{{ tableFieldShow('家庭住址', queryData.field) }}</li
              >
              <li class="width50"
                ><span>手机号码：</span>{{ tableFieldShow('手机号码', queryData.field) }}</li
              >
              <li class="width50"
                ><span>入职时间：</span>{{ tableFieldShow('入职时间', queryData.field) }}</li
              >
              <li class="width50"
                ><span>执法证号：</span>{{ tableFieldShow('执法证号', queryData.field) }}</li
              >
              <li class="width50"
                ><span>执法证有效期：</span
                >{{ tableFieldShow('执法证有效期', queryData.field) }}</li
              >
              <li class="width50"
                ><span>职务：</span>{{ tableFieldShow('职务', queryData.field) }}</li
              >
              <li class="width50"
                ><span>执法机构标识码：</span
                >{{ tableFieldShow('执法机构标识码', queryData.field) }}</li
              >
            </ul>
          </div>
          ...
          <div class="edit-content" v-loading="drawerConfig.loading" v-else>
            ...
            >
              ...
              <el-form-item
                ...
                prop="field.政治面貌"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入政治面貌', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入政治面貌"
                  v-model="formData.field.政治面貌"
                  clearable
                />
              </el-form-item>
              <el-form-item
                ...
                prop="field.民族"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入民族', trigger: 'blur' }]"
              >
                <el-input placeholder="请输入民族" v-model="formData.field.民族" clearable />
              </el-form-item>
              <el-form-item
                label="学历："
                prop="field.学历"
              ...
              >
                <el-input placeholder="请输入学历" v-model="formData.field.学历" clearable />
              </el-form-item>
              <el-form-item
                label="家庭住址："
                prop="field.家庭住址"
              ...
              <el-form-item
                ...
                prop="field.入职时间"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入入职时间', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入入职时间"
                  v-model="formData.field.入职时间"
                  clearable
                />
              </el-form-item>
              <el-form-item
                ...
                prop="field.执法证号"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入执法证号', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入执法证号"
                  v-model="formData.field.执法证号"
                  clearable
                />
              </el-form-item>
              <el-form-item
                ...
                prop="field.执法证有效期"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入执法证有效期', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入执法证有效期"
                  v-model="formData.field.执法证有效期"
                  clearable
                />
              </el-form-item>
              <el-form-item
              ...
              >
                <el-input placeholder="请输入职务" v-model="formData.field.职务" clearable />
              </el-form-item>
              <el-form-item
                label="执法机构标识码："
                prop="field.执法机构标识码"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入执法机构标识码', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入执法机构标识码"
                  v-model="formData.field.执法机构标识码"
                  clearable
                />
              </el-form-item>
            </el-form>
...
const tableInitData = async () => {
  ...
  try {
    let params = {
      ...
      sortOrder: 'DESC',
      assetProfileId: '4193c460-771f-11f0-bd39-2dc5ccdb39ef' //资产配置id
    }
...
const initFormData = {
  ...
  type: '执法人员信息管理', //资产配置，都是写死固定的资产配置
  field: {
    身份证号: '', //身份证号
    姓名: '', //姓名
    性别: '', //性别
...
const queryClick = async (row) => {
  ...
  drawerConfig.value.title = '执法人员信息管理-详细信息'
}
// 点击编辑按钮
const editClick = async (row) => {
  ...
  formData.value.field.身份证号 = tableFieldShow('身份证号', row.field) //身份证号
  formData.value.field.姓名 = tableFieldShow('姓名', row.field) //姓名
  formData.value.field.性别 = tableFieldShow('性别', row.field) //性别
  formData.value.field.政治面貌 = tableFieldShow('政治面貌', row.field) //政治面貌
  formData.value.field.民族 = tableFieldShow('民族', row.field) //民族
  formData.value.field.学历 = tableFieldShow('学历', row.field) //学历
  formData.value.field.家庭住址 = tableFieldShow('家庭住址', row.field) //家庭住址
  formData.value.field.手机号码 = tableFieldShow('手机号码', row.field) //手机号码
  formData.value.field.入职时间 = tableFieldShow('入职时间', row.field) //入职时间
  formData.value.field.执法证号 = tableFieldShow('执法证号', row.field) //执法证号
  formData.value.field.执法证有效期 = tableFieldShow('执法证有效期', row.field) //执法证有效期
  formData.value.field.职务 = tableFieldShow('职务', row.field) //职务
  formData.value.field.执法机构标识码 = tableFieldShow('执法机构标识码', row.field) //执法机构标识码

  drawerConfig.value.isDrawer = true
  drawerConfig.value.loading = false
  drawerConfig.value.type = 'edit'
  drawerConfig.value.title = '编辑执法人员信息管理'
}
// 点击删除按钮
const delClick = (row) => {
...
const addClick = async () => {
  ...
  drawerConfig.value.title = '新增执法人员信息管理'
}
...
const tableColumns = ref([
  ...
  { label: '政治面貌', visible: true },
  { label: '民族', visible: true },
  { label: '学历', visible: true },
  { label: '家庭住址', visible: true },
  { label: '手机号码', visible: true },
  { label: '入职时间', visible: true },
  { label: '执法证号', visible: true },
  { label: '执法证有效期', visible: true },
  { label: '职务', visible: true },
  { label: '执法机构标识码', visible: true }
])
// table表格数据
const tableData = ref([])
//table 配置
