      ...
      <div class="cc-title-css">
        ...
        <div class="right">
          <el-button
            ...
            v-hasPermi="['smarturban:parkgreenspacemgmt:create']"
          >
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('绿线坐标')"
          >
            <template #default="scope">
              {{ tableFieldShow('绿线坐标', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="植物种类"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('植物种类')"
          >
            <template #default="scope">
              {{ tableFieldShow('植物种类', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="服务设施"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('服务设施')"
          >
            <template #default="scope">
              {{ tableFieldShow('服务设施', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="建成时间"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('建成时间')"
          >
            <template #default="scope">
              {{ tableFieldShow('建成时间', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="管理单位"
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('开放时间')"
          >
            <template #default="scope">
              {{ tableFieldShow('开放时间', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="是否收费"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('是否收费')"
          >
            <template #default="scope">
              {{ tableFieldShow('是否收费', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="总面积"
          ...
          <el-table-column
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('绿化面积')"
          >
            <template #default="scope">
              {{ tableFieldShow('绿化面积', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="道路广场面积"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('道路广场面积')"
          >
            <template #default="scope">
              {{ tableFieldShow('道路广场面积', scope.row.field) }}
            </template>
          </el-table-column>
          <el-table-column
            label="水体面积"
            ...
            align="center"
            :show-overflow-tooltip="true"
            v-if="tableColumnShow('水体面积')"
          >
            <template #default="scope">
              {{ tableFieldShow('水体面积', scope.row.field) }}
            </template>
          </el-table-column>
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button
                ...
                v-hasPermi="['smarturban:parkgreenspacemgmt:query']"
                >详细</el-button
              >
              <el-button
                type="primary"
                ...
                v-hasPermi="['smarturban:parkgreenspacemgmt:update']"
                >编辑</el-button
              >
              <el-button
                type="danger"
                ...
                v-hasPermi="['smarturban:parkgreenspacemgmt:delete']"
                >删除</el-button
              >
            </template>
          </el-table-column>
        ...
        <div class="drawer-content">
          ...
          >
            <ul>
              ...
              >
              <li class="width50"
                ><span>绿线坐标：</span>{{ tableFieldShow('绿线坐标', queryData.field) }}</li
              >
              <li class="width50"
                ><span>植物种类：</span>{{ tableFieldShow('植物种类', queryData.field) }}</li
              >
              <li class="width50"
                ><span>服务设施：</span>{{ tableFieldShow('服务设施', queryData.field) }}</li
              >
              <li class="width50"
                ><span>建成时间：</span>{{ tableFieldShow('建成时间', queryData.field) }}</li
              >
              <li class="width50"
                ><span>管理单位：</span>{{ tableFieldShow('管理单位', queryData.field) }}</li
              >
              <li class="width50"
                ><span>开放时间：</span>{{ tableFieldShow('开放时间', queryData.field) }}</li
              >
              <li class="width50"
                ><span>是否收费：</span>{{ tableFieldShow('是否收费', queryData.field) }}</li
              >
              <li class="width50"
                ><span>总面积：</span>{{ tableFieldShow('总面积', queryData.field) }}</li
              >
              <li class="width50"
                ><span>绿化面积：</span>{{ tableFieldShow('绿化面积', queryData.field) }}</li
              >
              <li class="width50"
                ><span>道路广场面积：</span
                >{{ tableFieldShow('道路广场面积', queryData.field) }}</li
              >
              <li class="width50"
                ><span>水体面积：</span>{{ tableFieldShow('水体面积', queryData.field) }}</li
              >
            </ul>
          </div>
          ...
          <div class="edit-content" v-loading="drawerConfig.loading" v-else>
            ...
            >
              ...
              <el-form-item
                ...
                prop="field.植物种类"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入植物种类', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入植物种类"
                  v-model="formData.field.植物种类"
                  clearable
                />
              </el-form-item>
              <el-form-item
                ...
                prop="field.服务设施"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入服务设施', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入服务设施"
                  v-model="formData.field.服务设施"
                  clearable
                />
              </el-form-item>
              <el-form-item
              ...
              <el-form-item
                ...
                prop="field.是否收费"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入是否收费', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入是否收费"
                  v-model="formData.field.是否收费"
                  clearable
                />
              </el-form-item>
              <el-form-item
              ...
              <el-form-item
                ...
                prop="field.绿化面积"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入绿化面积', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入绿化面积"
                  v-model="formData.field.绿化面积"
                  clearable
                />
              </el-form-item>
              <el-form-item
                ...
                prop="field.道路广场面积"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入道路广场面积', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入道路广场面积"
                  v-model="formData.field.道路广场面积"
                  clearable
                />
              </el-form-item>
              <el-form-item
                ...
                prop="field.水体面积"
                class="edit-content-form-li width50"
                :rules="[{ required: true, message: '请输入水体面积', trigger: 'blur' }]"
              >
                <el-input
                  placeholder="请输入水体面积"
                  v-model="formData.field.水体面积"
                  clearable
                />
              </el-form-item>
            </el-form>
...
const tableInitData = async () => {
  ...
  try {
    let params = {
      ...
      sortOrder: 'DESC',
      assetProfileId: 'f9b8b620-7726-11f0-bd39-2dc5ccdb39ef' //资产配置id
    }
...
const queryClick = async (row) => {
  ...
  drawerConfig.value.title = '公园绿地管理-详细信息'
}
// 点击编辑按钮
const editClick = async (row) => {
  ...
  formData.value.field.绿线坐标 = tableFieldShow('绿线坐标', row.field) //绿线坐标
  formData.value.field.植物种类 = tableFieldShow('植物种类', row.field) //植物种类
  formData.value.field.服务设施 = tableFieldShow('服务设施', row.field) //服务设施
  formData.value.field.建成时间 = tableFieldShow('建成时间', row.field) //建成时间
  formData.value.field.管理单位 = tableFieldShow('管理单位', row.field) //管理单位
  formData.value.field.开放时间 = tableFieldShow('开放时间', row.field) //开放时间
  formData.value.field.是否收费 = tableFieldShow('是否收费', row.field) //是否收费
  formData.value.field.总面积 = tableFieldShow('总面积', row.field) //总面积
  formData.value.field.绿化面积 = tableFieldShow('绿化面积', row.field) //绿化面积
  formData.value.field.道路广场面积 = tableFieldShow('道路广场面积', row.field) //道路广场面积
  formData.value.field.水体面积 = tableFieldShow('水体面积', row.field) //水体面积

  drawerConfig.value.isDrawer = true
  drawerConfig.value.loading = false
  drawerConfig.value.type = 'edit'
  drawerConfig.value.title = '编辑公园绿地管理'
}
// 点击删除按钮
const delClick = (row) => {
...
const addClick = async () => {
  ...
  drawerConfig.value.title = '新增公园绿地管理'
}
...
const tableColumns = ref([
  ...
  { label: '绿线坐标', visible: true },
  { label: '植物种类', visible: true },
  { label: '服务设施', visible: true },
  { label: '建成时间', visible: true },
  { label: '管理单位', visible: true },
  { label: '开放时间', visible: true },
  { label: '是否收费', visible: true },
  { label: '总面积', visible: true },
  { label: '绿化面积', visible: true },
  { label: '道路广场面积', visible: true },
  { label: '水体面积', visible: true }
])
// table表格数据
const tableData = ref([])
//table 配置
