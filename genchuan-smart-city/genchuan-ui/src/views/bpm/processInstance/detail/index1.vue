    ...
    <div class="processInstance-wrap-main">
      <el-scrollbar>
        ...
        <div class="b-t-solid border-t-1px border-[var(--el-border-color)]">
          <!-- 操作栏按钮 -->
          <ProcessInstanceOperationButton1
...
import ProcessInstanceOperationButton1 from './ProcessInstanceOperationButton1.vue'
...
defineOptions({ name: 'BpmProcessInstanceDetail1' })
