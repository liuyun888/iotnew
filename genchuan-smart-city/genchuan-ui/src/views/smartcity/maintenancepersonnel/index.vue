<template>
    ...
    >
      ...
      <el-form-item style="margin-left: 60px">
        ...
        <el-button
          ...
          v-hasPermi="['smartcity:maintenance-personnel:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['smartcity:maintenance-personnel:export']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="人员编号" align="center" prop="personnelId" />
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['smartcity:maintenance-personnel:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['smartcity:maintenance-personnel:delete']"
          >
            删除
          </el-button>
        </template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <MaintenancePersonnelForm ref="formRef" @success="getList" />
</template>
...
/** 养护人员 列表 */
defineOptions({ name: 'MaintenancePersonnel' })

const message = useMessage() // 消息弹窗
const { t } = useI18n() // 国际化

const loading = ref(true) // 列表的加载中
const list = ref<MaintenancePersonnelVO[]>([]) // 列表的数据
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await MaintenancePersonnelApi.deleteMaintenancePersonnel(id)
