<template>
  ...
  <div class="page-container">
    <div class="head-top">
      ...
      <span class="head-name">产业园区-{{ name }}</span>
...
const leftNavList = ref([
  ...
  {name: '分域场景专题', path: '', tag: '0902'},
  {name: '核心业务指标', path: '', tag: '0903'}
]);
const rightNavList = ref([
  {name: '事件预警追踪', path: '', tag: '0904'},
  {name: '应急指挥视图', path: '', tag: '0905'},
  {name: '跨域场景协同', path: '', tag: '0906'}
]);
const name = ref('');
