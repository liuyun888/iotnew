<template>
  ...
  <div class="page-container">
    <div class="head-top">
      ...
      <span class="head-name">应急安全-{{ name }}</span>
...
const leftNavList = ref([
  ...
  {name: '分域场景专题', path: '', tag: '0502'},
  {name: '核心业务指标', path: '', tag: '0503'}
]);
const rightNavList = ref([
  {name: '事件预警追踪', path: '', tag: '0504'},
  {name: '应急指挥视图', path: '', tag: '0505'},
  {name: '跨域场景协同', path: '', tag: '0506'}
]);
const name = ref('');
