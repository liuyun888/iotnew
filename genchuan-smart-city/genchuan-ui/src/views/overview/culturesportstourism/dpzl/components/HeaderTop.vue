<template>
  ...
  <div class="page-container">
    <div class="head-top">
      ...
      <span class="head-name">文体旅游-{{ name }}</span>
...
const leftNavList = ref([
  ...
  {name: '分域场景专题', path: '', tag: '0802'},
  {name: '核心业务指标', path: '', tag: '0803'}
]);
const rightNavList = ref([
  {name: '事件预警追踪', path: '', tag: '0804'},
  {name: '应急指挥视图', path: '', tag: '0805'},
  {name: '跨域场景协同', path: '', tag: '0806'}
]);
const name = ref('');
