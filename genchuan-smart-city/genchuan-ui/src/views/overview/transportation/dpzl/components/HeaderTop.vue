<template>
  ...
  <div class="page-container">
    <div class="head-top">
      ...
      <span class="head-name">交通运输-{{ name }}</span>
...
const leftNavList = ref([
  ...
  {name: '分域场景专题', path: '', tag: '0402'},
  {name: '核心业务指标', path: '', tag: '0403'}
]);
const rightNavList = ref([
  {name: '事件预警追踪', path: '', tag: '0404'},
  {name: '应急指挥视图', path: '', tag: '0405'},
  {name: '跨域场景协同', path: '', tag: '0406'}
]);
const name = ref('');
