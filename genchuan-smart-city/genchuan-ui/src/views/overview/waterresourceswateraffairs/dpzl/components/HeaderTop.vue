<template>
  ...
  <div class="page-container">
    <div class="head-top">
      ...
      <span class="head-name">水利水务-{{ name }}</span>
...
const leftNavList = ref([
  ...
  {name: '分域场景专题', path: '', tag: '0202'},
  {name: '核心业务指标', path: '', tag: '0203'}
]);
const rightNavList = ref([
  {name: '事件预警追踪', path: '', tag: '0204'},
  {name: '应急指挥视图', path: '', tag: '0205'},
  {name: '跨域场景协同', path: '', tag: '0206'}
]);
const name = ref('');
