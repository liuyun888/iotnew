<template>
  ...
  <div class="page-container">
    <div class="head-top">
      ...
      <span class="head-name">生态环保-{{ name }}</span>
...
const leftNavList = ref([
  ...
  {name: '分域场景专题', path: '', tag: '0302'},
  {name: '核心业务指标', path: '', tag: '0303'}
]);
const rightNavList = ref([
  {name: '事件预警追踪', path: '', tag: '0304'},
  {name: '应急指挥视图', path: '', tag: '0305'},
  {name: '跨域场景协同', path: '', tag: '0306'}
]);
const name = ref('');
