...
console.log(import.meta.env.VITE_USER_NODE_ENV,22222)
console.log(import.meta.env.VITE_THINGS_BOARD_URL,333)
const http = axios.create({
  // 设置超时时间
  timeout: 30000,
  // baseURL: '/thingsBoard-api'
  baseURL: import.meta.env.VITE_USER_NODE_ENV === "development" ? '/shizhen-api' : `${import.meta.env.VITE_URBAN_LAW_ENFORCEMENT_URL}`
})
// 添加请求拦截器
