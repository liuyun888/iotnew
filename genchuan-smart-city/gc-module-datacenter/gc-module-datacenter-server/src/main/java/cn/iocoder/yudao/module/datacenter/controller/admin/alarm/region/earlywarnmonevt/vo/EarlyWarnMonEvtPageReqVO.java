...
@Schema(description = "管理后台 - 按监测事件预警告警统计分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class EarlyWarnMonEvtPageReqVO extends PageParam {
    ...
    @Schema(description = "事件大类ID")
    private String evtMajorId;

    @Schema(description = "事件大类名称")
    private String evtMajorName;

    @Schema(description = "事件小类ID")
    private String evtMinorId;

    @Schema(description = "事件小类名称")
