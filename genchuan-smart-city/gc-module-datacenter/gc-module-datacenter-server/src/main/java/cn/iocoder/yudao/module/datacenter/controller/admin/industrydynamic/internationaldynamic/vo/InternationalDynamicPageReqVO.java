...
@Schema(description = "管理后台 - 国际行业动态分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class InternationalDynamicPageReqVO extends PageParam {

    @Schema(description = "动态ID，唯一编码，UUID生成", example = "18998")
    private String internationalDynamicId;

    @Schema(description = "动态标题（中文），如“新加坡推出智慧国2.0计划”")
    private String dynamicTitle;

    @Schema(description = "英文标题，动态标题（英文）")
    private String dynamicTitleEn;

    @Schema(description = "来源国家地区，如“新加坡”“欧盟”")
    private String sourceCountry;

    @Schema(description = "动态来源，如“Smart City World”")
