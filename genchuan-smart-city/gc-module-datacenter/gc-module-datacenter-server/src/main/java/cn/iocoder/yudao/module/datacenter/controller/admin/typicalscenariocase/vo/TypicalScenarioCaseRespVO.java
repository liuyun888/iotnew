...
@Schema(description = "管理后台 - 典型场景案例库 Response VO")
@Data
@ExcelIgnoreUnannotated
public class TypicalScenarioCaseRespVO {
    ...
    @ExcelProperty("案例ID，唯一编码，UUID生成")
    ...
    @ExcelProperty("案例名称，如“2025年XX区域燃气泄漏事件优化案例”")
    ...
    @ExcelProperty("核心措施，案例的核心实施措施（分点描述），决策方案表（biz_decision_scheme）")
    ...
    @ExcelProperty("资源投入，如“传感器3台（8万元）、人员2名（5万元）”，决策方案表（biz_decision_scheme）")
    ...
    @ExcelProperty("实施效果，如“事件下降55%，响应时长缩短至18分钟”，决策效果评估表（biz_decision_effect_eval）")
