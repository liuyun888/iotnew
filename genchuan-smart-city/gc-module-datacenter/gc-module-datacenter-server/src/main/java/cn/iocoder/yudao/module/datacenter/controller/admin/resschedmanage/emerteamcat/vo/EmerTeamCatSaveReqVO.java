package cn.iocoder.yudao.module.datacenter.controller.admin.resschedmanage.emerteamcat.vo;
...
@Schema(description = "管理后台 - 救援队伍分类配置新增/修改 Request VO")
@Data
public class EmerTeamCatSaveReqVO {

    @Schema(description = "自增主键ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "16287")
    private Long id;

    @Schema(description = "分类ID，唯一编码，UUID", requiredMode = Schema.RequiredMode.REQUIRED, example = "3391")
    @NotEmpty(message = "分类ID，唯一编码，UUID不能为空")
    private String teamCatId;

    @Schema(description = "父分类ID，关联本表“分类ID”", requiredMode = Schema.RequiredMode.REQUIRED, example = "26062")
