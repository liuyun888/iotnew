...
@Schema(description = "管理后台 - 按应用场景预警告警统计 Response VO")
@Data
@ExcelIgnoreUnannotated
public class EarlyWarnAppSceneRespVO {
