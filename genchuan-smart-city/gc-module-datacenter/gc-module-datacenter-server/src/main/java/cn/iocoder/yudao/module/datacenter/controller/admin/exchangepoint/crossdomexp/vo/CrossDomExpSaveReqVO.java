...
@Schema(description = "管理后台 - 跨域经验交流新增/修改 Request VO")
@Data
public class CrossDomExpSaveReqVO {
    ...
    @NotEmpty(message = "经验标题，如“上海一网统管平台设备联动经验”不能为空")
    ...
    @NotEmpty(message = "经验领域代码，取值如01=设备联动，02=数据融合，03=事件处置，经验领域字典表（sys_dict_exp_field）不能为空")
    ...
    @NotNull(message = "浏览次数，用户浏览经验的次数，默认0不能为空")
