...
@Schema(description = "管理后台 - 任务模板管理分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class EvalTaskTemplatePageReqVO extends PageParam {
    ...
    @Schema(description = "关联指标体系ID")
    private String idxSystemId;

    @Schema(description = "关联指标体系名称")
    private String idxSystemName;

    @Schema(description = "关联评价主体ID")
    private String evalSubjectId;

    @Schema(description = "关联评价主体名称")
