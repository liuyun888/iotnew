...
@Schema(description = "管理后台 - 跨域调度协调 Response VO")
@Data
@ExcelIgnoreUnannotated
public class CrossRegionDispatchRespVO {
    ...
    @ExcelProperty("申请单位ID，发起申请的本地联动单位ID，关联联动单位信息表（biz_coop_unit_info）")
    ...
    @ExcelProperty("申请单位名称，与申请单位ID同步，关联联动单位信息表（biz_coop_unit_info）")
    ...
    @ExcelProperty("协作单位ID，跨域协作单位ID，关联联动单位信息表（biz_coop_unit_info）")
    ...
    @ExcelProperty("协作单位名称，与协作单位ID同步，关联联动单位信息表（biz_coop_unit_info）")
