...
@Schema(description = "管理后台 - 扩展监测事件配置 Response VO")
@Data
@ExcelIgnoreUnannotated
public class MonEvtExtRespVO {
    ...
    @ExcelProperty("所属中类ID，关联事件分类表中类ID；监测事件分类配置表(sys_mon_evt_cat)")
