...
@Schema(description = "管理后台 - 监测事件数据配置新增/修改 Request VO")
@Data
public class MonEvtDataCfgSaveReqVO {
    ...
    @NotEmpty(message = "事件分类名称，与分类ID同步，自动填充，监测事件分类配置表(sys_mon_evt_cat)不能为空")
