...
@Schema(description = "管理后台 - 跨域经验交流分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class CrossDomExpPageReqVO extends PageParam {

    @Schema(description = "经验ID，唯一编码，UUID生成", example = "21164")
    private String crossDomExpId;

    @Schema(description = "经验标题，如“上海一网统管平台设备联动经验”")
    private String expTitle;

    @Schema(description = "经验领域代码，取值如01=设备联动，02=数据融合，03=事件处置，经验领域字典表（sys_dict_exp_field）")
    private String expFieldCode;

    @Schema(description = "经验领域名称，与经验领域代码同步，经验领域字典表（sys_dict_exp_field）", example = "王五")
    private String expFieldName;

    @Schema(description = "来源城市，如“上海、深圳”，行政区划表（sys_area）")
    private String sourceCity;

    @Schema(description = "经验详细内容（支持富文本，如“1.设备联动：统一物联网设备协议；2.数据融合：建立跨部门数据中台”）")
    ...
    @Schema(description = "浏览次数，用户浏览经验的次数，默认0", example = "1241")
