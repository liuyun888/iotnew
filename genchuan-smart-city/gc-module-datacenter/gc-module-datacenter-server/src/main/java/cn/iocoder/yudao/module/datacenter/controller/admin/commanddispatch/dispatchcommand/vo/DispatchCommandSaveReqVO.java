...
@Schema(description = "管理后台 - 调度指令新增/修改 Request VO")
@Data
public class DispatchCommandSaveReqVO {
    ...
    @NotEmpty(message = "任务内容，从方案同步，可补充细节，如“派遣2辆救援车，携带救生设备，1小时内到达XX内涝点”不能为空")
