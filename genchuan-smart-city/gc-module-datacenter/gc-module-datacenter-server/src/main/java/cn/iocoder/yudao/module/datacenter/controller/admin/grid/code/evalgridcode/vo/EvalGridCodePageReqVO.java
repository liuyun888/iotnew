...
@Schema(description = "管理后台 - 评价网格编码分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class EvalGridCodePageReqVO extends PageParam {

    @Schema(description = "编码ID", example = "6750")
    private String evalCodeId;

    @Schema(description = "评价网格标识码")
    private String evalGridCode;

    @Schema(description = "所属评价网格ID", example = "27254")
