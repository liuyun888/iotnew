...
@Schema(description = "管理后台 - 按监测事件分析研判统计新增/修改 Request VO")
@Data
public class AnalysisMonEvtSaveReqVO {

    @Schema(description = "主键ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "11026")
    private Long id;

    @Schema(description = "统计ID，唯一编码，UUID生成", requiredMode = Schema.RequiredMode.REQUIRED, example = "19985")
