...
public class FaqSaveReqVO {
    ...
    @NotEmpty(message = "FAQ ID，唯一编码，UUID生成不能为空")
    ...
    @NotEmpty(message = "问题类型代码，01=系统操作问题，02=业务数据问题，03=流程执行问题，问题类型字典表（sys_dict_question_type）不能为空")
