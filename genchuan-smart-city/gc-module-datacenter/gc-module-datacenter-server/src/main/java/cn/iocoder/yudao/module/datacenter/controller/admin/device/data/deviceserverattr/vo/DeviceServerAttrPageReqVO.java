package cn.iocoder.yudao.module.datacenter.controller.admin.device.data.deviceserverattr.vo;
...
@Schema(description = "管理后台 - 设备服务器属性配置分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class DeviceServerAttrPageReqVO extends PageParam {
