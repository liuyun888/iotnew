...
@Schema(description = "管理后台 - 资源匹配调度分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ResMatchSchedulePageReqVO extends PageParam {

    @Schema(description = "调度ID，唯一编码，UUID生成", example = "22687")
    private String resScheduleId;

    @Schema(description = "关联方案ID，关联决策方案表的方案ID，决策方案表（biz_decision_scheme）", example = "13199")
    ...
    @Schema(description = "调度状态：待匹配/匹配中/匹配成功/匹配失败/调度完成，标识调度进度", example = "2")
    ...
    @Schema(description = "调度人，发起调度的用户ID，用户信息表（sys_user）")
    private String scheduleUser;

    @Schema(description = "调度时间，格式：yyyy-MM-dd HH:mm:ss")
