...
@Schema(description = "管理后台 - 咨询建议分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class PublicConsultationPageReqVO extends PageParam {

    @Schema(description = "咨询ID，唯一编码，UUID生成", example = "23767")
    private String consultId;

    @Schema(description = "咨询单号，格式“ZX+YYYYMMDD+6位流水号”")
    private String consultNo;

    @Schema(description = "咨询类型编码，类型（如“政策咨询”“建设建议”），字典表（sys_dict）")
    private String consultTypeCode;

    @Schema(description = "咨询类型名称，与类型编码同步，字典表（sys_dict）", example = "李四")
    private String consultTypeName;

    @Schema(description = "咨询内容，市民咨询或建议内容")
    private String consultContent;

    @Schema(description = "联系人姓名，咨询人姓名", example = "王五")
    ...
    @Schema(description = "咨询状态：1=待回复，2=已回复，3=已采纳（建议类），流程状态", example = "1")
