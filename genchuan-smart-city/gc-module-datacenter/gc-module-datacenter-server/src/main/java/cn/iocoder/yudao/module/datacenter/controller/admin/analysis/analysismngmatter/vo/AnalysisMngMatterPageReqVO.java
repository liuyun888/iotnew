...
@Schema(description = "管理后台 - 按管理事项分析研判统计分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class AnalysisMngMatterPageReqVO extends PageParam {

    @Schema(description = "统计ID，唯一编码，UUID生成", example = "31916")
    private String statAnalysisId;

    @Schema(description = "统计周期，格式：年/季/月，如YYYY/YYYYQn/YYYYMM")
    private String statCycle;

    @Schema(description = "统计周期名称，如“2025年09月”", example = "李四")
    private String statCycleName;

    @Schema(description = "事项大类ID，关联管理事项分类表", example = "17953")
    private String matterMajorId;

    @Schema(description = "事项大类名称，与大类ID同步，关联管理事项分类表", example = "王五")
    ...
    @Schema(description = "事项上报总量，周期内该分类事项上报总数", example = "9112")
    private Integer totalRptCount;

    @Schema(description = "事项办结率，办结事项数/(上报总量-驳回数)×100，0.00-100.00")
