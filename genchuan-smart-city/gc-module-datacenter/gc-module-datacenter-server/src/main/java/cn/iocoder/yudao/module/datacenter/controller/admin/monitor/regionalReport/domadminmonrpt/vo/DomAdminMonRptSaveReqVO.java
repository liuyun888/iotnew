package cn.iocoder.yudao.module.datacenter.controller.admin.monitor.regionalReport.domadminmonrpt.vo;
...
@Schema(description = "管理后台 - 行政区划分域监测报表新增/修改 Request VO")
@Data
public class DomAdminMonRptSaveReqVO {
    ...
    @Schema(description = "行政区划层级", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotEmpty(message = "行政区划层级不能为空")
